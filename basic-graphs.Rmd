...
#Major differences from thesis figures: more spaced out legend, no gridlines, slightly larger labels, y axis scale to -25
...
tiff("\\Figures\\EcoEng\\N2-flux-by-season", width = 300, height = 250, units = "mm", res = 300, compression = "lzw")
...
tiff("\\Figures\\EcoEng\\annual-DNE", width = 300, height = 250, units = "mm", res = 300, compression = "lzw")
...
annual_eff_years %>%
  ...
  theme(panel.background = element_rect(fill = "white", colour = NA),
       ...
       legend.text = element_text(size = 22)) +
  guides(fill = guide_legend(title = "Restored Age", 
                             keywidth = 0.4, keyheight = 0.4, default.unit = "inch")) +
  scale_fill_manual(values = c("slategray2", "skyblue2", "skyblue3", "skyblue4"),
                    labels = c("  0 years",
                               "  2 years",
                               "  7 years",
...
tiff("\\Figures\\EcoEng\\annual-N2O-flux-by-habitat", width = 300, height = 250, units = "mm", res = 300, compression = "lzw")

annual.N2O.age %>%
  ggplot(aes(Age, annual_N2O, fill = Habitat)) +
  geom_bar(stat = "identity", position = "dodge", width = 0.8) +
  geom_errorbar(aes(ymin = annual_N2O - se, ymax = annual_N2O + se), position = position_dodge(0.8), width = 0.3) +
