...
#Interestingly, passes Levene Test for Site and Habitat; fails for Season (change 2nd parameter
#after ~ to explore)
...
interact.anova <- aov(N2Flux ~ Season * Habitat, data = BC.N2)
