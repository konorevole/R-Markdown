...
tiff("Annual N2 regression", width = 400, height = 160, units = "mm", res = 300, compression = "lzw")
...
tiff("Summer N2 regression", width = 400, height = 160, units = "mm", res = 300, compression = "lzw")
...
tiff("Fall N2 regression", width = 400, height = 160, units = "mm", res = 300, compression = "lzw")

annual.data %>%
  filter(Season == "Fall") %>%
  ggplot(aes(Age, N2Flux)) +
  geom_hline(yintercept = 0, size = 0.2, colour = "grey13") +
  geom_vline(xintercept = 0, size = 0.2, colour = "grey13") +
  geom_point(size = 4) +
  theme(panel.background = element_rect(fill = "white", colour = NA),
       axis.title.x = element_text(margin = margin(t = 15), size = 26),
       axis.title.y = element_text(margin = margin(r = 15), size = 26),
