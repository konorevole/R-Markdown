...
#Add regression lines to show various regressions
...
#This is the annual version of the above
...
#Again, only % OM has significant p-value and decent R2
melted.annual %>%
  ggplot(aes(Age, value)) +
  geom_point() +
  facet_grid(variable ~ ., scales = "free_y") +
...
#Same as above but with filter function to present each season individually
